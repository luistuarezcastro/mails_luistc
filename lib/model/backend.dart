...
class Backend {
  ...
  final _emails = [
    Email(
      id: 631,
      from: 'tuarezluis62@gmail.com',
      subject: 'luis tuarez',
      dateTime: DateTime(2020, 10, 03, 19, 43),
      body:
          'Hola este deber es para aplicaciones moviles',
    ),
    Email(
      id: 522,
      from: 'cocacola@cola.com',
      subject: 'Informe coca cola',
      dateTime: DateTime(2020, 10, 07, 03, 05),
      body:
          ' Refrescate con una coca cola bien fria a tan solo 50 centavos',
    ),
    Email(
      id: 963,
      from: 'doritos@snacks.com',
      subject: 'doritos',
    ...
    Email(
      id: 164,
      read: true,
      from: 'nike@zapatos.com',
      subject: 'nike',
      dateTime: DateTime(2020, 10, 11, 16, 14),
      body:
          'tenemos nuevos zapatos',
    ),
    Email(
      id: 835,
